...
import static io.primeval.common.base.Preconditions.checkArgument;
import static io.primeval.common.base.Preconditions.checkNotNull;
...
public final class ThreadFactoryBuilder {
     ...
     *
     * @param daemon
     *            whether or not new Threads created with this ThreadFactory will be daemon threads
     * @return this for the builder pattern
     */
     ...
     *            the uncaught exception handler for new Threads created with this ThreadFactory
     * @return this for the builder pattern
     */
    ...
    /**
     * Sets the backing {@link ThreadFactory} for new threads created with this ThreadFactory. Threads will be created by invoking #newThread(Runnable) on this
    ...
    /**
     * Returns a new thread factory using the options supplied during the building process. After building, it is still possible to change the options used to
     * build the ThreadFactory and/or build again. State is not shared amongst built instances.
     *
